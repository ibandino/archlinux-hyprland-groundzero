...
iDoR="$HOME/archlinux-hyprland-groundzero/Hyprland-Dots-main/.config/swaync/images"
sDIR="$HOME/archlinux-hyprland-groundzero/Hyprland-Dots-main/.config/hypr/scripts"
